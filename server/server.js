...
/* Ако портът е зает, най-честата причина е друга игра или друг сървър,
   който още работи. По-полезно е да се каже това, отколкото да гръмне.
...
httpServer.on("error", err => {
  if(err.code === "EADDRINUSE"){
    console.log(`
  ╔════════════════════════════════════════════════════════╗
  ║   ПОРТЪТ Е ЗАЕТ ОТ ДРУГА ПРОГРАМА                      ║
  ╚════════════════════════════════════════════════════════╝

  Порт ${PORT} вече се ползва — най-често от друга игра или
  сървър, чийто черен прозорец още стои отворен.

  Или:
    1. Затвори другия черен прозорец и пусни това пак
    2. Или пусни това на друг порт - отвори командния ред тук и напиши:
         set PORT=8090 && START.bat
       тогава адресът става http://127.0.0.1:8090/index.html
`);
  }else{
